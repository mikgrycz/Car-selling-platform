...
model_2 = keras.Sequential([Dense(30, input_shape=[7], activation='relu'),
...
model_3 = keras.Sequential([Dense(20, input_shape=[7], activation='relu'),
                           Dense(40, activation='relu'),
                           Dense(10, activation='relu'),
                           Dense(1)])

model_4 = keras.Sequential([Dense(7, input_shape=[7], activation='relu'),
